...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setApplicationName("DLTTestRobot");
    QCoreApplication::setApplicationVersion(DLT_TEST_ROBOT_VERSION);

    QCommandLineParser parser;
    parser.setApplicationDescription("Test Engine for DLT.");
